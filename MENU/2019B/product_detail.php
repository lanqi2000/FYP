            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <?php
                    ...
                    if($user==""){
                        echo '<a class="nav-link text-white" href="index.php">Login</a>';
                    }
                    else{
                        echo '<a class="nav-link text-white" href="product_list.php">Logout</a>';
                    }//href="product_detail.php?u=logout"
                ?>
            </div>
        </nav>
                            ...
                            <div class="col-sm-6">
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div style="height:100px">RM <?php echo $price; ?></div><br/>
                                        <?php
                                            ...
                                            ?>
                                        <div style="height:100px">Quantity  <input type="number" name="quantity" value="1" min="1" max="<?php echo $quantity-$countProduct;?>">Available stock : <?php echo $quantity-$countProduct;?><input name="userID" type="hidden" value="<?php echo $user;?>"/> 
