    ...
    <body>           
            ...
            <form method="post" action="insertInvoice.php">
                <div class="row" style="padding-top:20px;">
                    <div class="col-md-2">
                        <ul class="list-group">
                            <li class="list-group-item"><a href="product_list.php">Brands</a></li>
    ...
    ?>
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">  
                                        ...
                                        <input type="text" value=" <?php echo $price*$quantity; ?>" name="subamount[]" size="6" id="subamount[]" /> 
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                ?>
                    ...
                    <br>Tax <input type="text" name="tax" id="tax">
                    <br><input type="submit" value="Check Out">
                    <br><input type="button" value="Calculate" onclick="cal()">Total <input type="text" name="total" id="total">
                    </div>
